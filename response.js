...
import CachedRequestManager from "./models/cachedRequestManager.js";
...
export default class Response {
    ...
    JSON(obj, ETag = "", fomCache = false) {                         // ok status with content
        if (!fomCache && this.HttpContext.path.isAPI && this.HttpContext.path.id == undefined) {
            CachedRequestManager.add(this.HttpContext.req.url, obj, ETag);
        }
        if (ETag != "")
